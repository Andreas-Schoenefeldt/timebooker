...
const fs = require("fs");
const reportsPath = './data/report.csv';
...
if (fs.existsSync(reportsPath)) {
            ...
            if (!ignoreMap[entry.activity]) {
                ...
                if (activities[entry.activity]) {
                    ...
                    entry.info.forEach( (comment) => {
                        let ticket = activityConf.defaultTicket;
                        ...
                        if (byCustomer[customer]) {
                            ...
                            throw new Error('missing byCustomer line parser configuration');
                        }
    ...
    needle.get('https://time.emphasize.de/util/report.php?export=csv&type=daily&token=6148lk4g4gk8c0c8wgo0&from=2022-01-01&to=2022-01-09&Submit=Show', {
        open_timeout: 30000
